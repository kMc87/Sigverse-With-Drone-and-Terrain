...
namespace SIGVerse.Human
{
	...
	public class ThirdPersonDroneCrontrollerwithDroneSpeed : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			// read inputs
#if !UNITY_ANDROID
			float h = CrossPlatformInputManager.GetAxis("Horizontal") * drone_speed;
			float v = CrossPlatformInputManager.GetAxis("Vertical") * drone_speed;
